...
md"""
Number of repitions r: $(@bind r Scrubbable(10 .^(0:6), default=10000))
"""
...
let
	Y = rand(Cauchy(),n,r)
	Ȳ =  mapslices(mean,Y,dims=1) |> vec
	histogram(Ȳ,xlim=(-10,10), bins=range(-10,10,length=round(Int,sqrt(r))),label="",normalize=:density,color=:lightblue)
	plot!(y->pdf(Cauchy(),y)*r,-10,10,color=:black,label="Cauchy distribution")
end
